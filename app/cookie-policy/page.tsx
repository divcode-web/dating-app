      ...
      <Card className="p-8">
        ...
        <div className="space-y-8 text-gray-700">
          ...
          <section>
            ...
            <p className="mb-4">
              This Cookie Policy explains how Dating App ("we", "us", or "our") uses cookies and
              similar technologies to recognize you when you visit our website and mobile application.
          ...
          <section>
            ...
            <p>
              Cookies set by the website owner (in this case, Dating App) are called "first-party cookies".
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-semibold text-lg mb-2">3.1 Necessary Cookies</h3>
                <p className="mb-2">
                ...
                <p className="text-sm">
                  <strong>Examples:</strong> Authentication cookies, security cookies, session cookies
                </p>
                <p className="text-sm mt-2">
                  <strong>Legal Basis:</strong> These cookies are necessary for the performance of a
                  contract between you and us (Article 6(1)(b) GDPR).
                </p>
              </div>

              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-semibold text-lg mb-2">3.2 Analytics Cookies</h3>
                <p className="mb-2">
                  These cookies collect information about how you use our website, such as which
                  pages you visit most often. This data is used to optimize our website and make
                  it easier for you to navigate.
                </p>
                <p className="text-sm">
                  <strong>Examples:</strong> Google Analytics, internal analytics
                </p>
                <p className="text-sm mt-2">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-semibold text-lg mb-2">3.3 Marketing Cookies</h3>
                <p className="mb-2">
          ...
          <section>
            ...
            <div className="space-y-3">
              <p>
                <strong>Session Cookies:</strong> These cookies are temporary and expire when you
                close your browser.
              </p>
              <p>
                <strong>Persistent Cookies:</strong> These cookies remain on your device for a set
                period (typically 12 months) or until you delete them.
              </p>
            </div>
          </section>
          ...
          {/* Your rights */}
          <section>
            <h2 className="text-2xl font-bold mb-4">5. Your Cookie Choices and Rights</h2>
            <div className="space-y-4">
              <div>
                ...
                <p className="mb-2">
                  ...
                  your cookie rights by setting your preferences in our cookie consent banner when
              ...
              <div>
                ...
                <p className="mb-2">
                  ...
                  The method for disabling cookies may vary from browser to browser:
                </p>
              ...
              <div>
                ...
                <p>
                  You can withdraw your consent to our use of analytics and marketing cookies at any
                  time by clearing your browser cookies or adjusting your cookie preferences.
                </p>
              </div>

              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                <p className="text-sm">
                  <strong>Please note:</strong> If you choose to block or delete cookies, some features
                  of our website may not function properly or may not be available to you.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              We may use third-party service providers who are allowed to place cookies on your
              device on our behalf to perform certain functions described in this policy. These
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p>
                  Under the GDPR, we require your explicit consent before setting non-essential cookies.
              ...
              <div>
                <h3 className="font-semibold mb-2">7.2 California Users (CCPA)</h3>
                <p>
                  California residents have the right to opt-out of the "sale" of personal information.
                  While we do not sell personal information in the traditional sense, sharing data
                  with advertising partners may constitute a "sale" under CCPA. You can opt-out by
              ...
              <div>
                ...
                <p>
                  ...
                  including providing appropriate notices and obtaining necessary consents.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              not want to have your online activities tracked. We currently do not respond to browser
              "Do Not Track" signals, but you can manage your cookie preferences through our cookie
          ...
          <section>
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              <p><strong>Email:</strong> privacy@datingapp.com</p>
              <p><strong>Address:</strong> [Your Company Address]</p>
              <p><strong>Data Protection Officer:</strong> dpo@datingapp.com</p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>
              Cookie consent choices are stored for 12 months. After this period, you will be asked
              to renew your preferences. Session cookies are deleted when you close your browser.
              Persistent cookies remain for the duration specified in their settings or until you
              delete them.
            </p>
          </section>
