        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              By accessing or using lovento ("the Service"), you agree to be
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                You have not been convicted of or pleaded no contest to a felony
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed font-semibold">
              ...
              Service. You agree NOT to post content that:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>
                Contains nudity, sexually explicit material, or pornographic
                content
              </li>
              <li>
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              We reserve the right to verify profiles through photo
              verification, identity verification, or other means. Verified
              profiles receive a verification badge. Misrepresenting yourself or
              using fake photos may result in immediate account termination.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              Premium features require a paid subscription. By purchasing a
              subscription:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              settings. Refunds are provided only in accordance with applicable
              law. If you violate these Terms, you forfeit any right to a
              refund.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              We use AI-powered and human moderation to review content. We
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              are owned by lovento and are protected by international copyright,
              trademark, and other intellectual property laws. You retain
              ownership of content you post, but grant us a worldwide,
          ...
          <section className="space-y-3">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
              ...
              <p className="text-yellow-700 mt-2">
                lovento does not conduct criminal background checks on users.
                You are solely responsible for your interactions with other
                users. Always meet in public places, tell someone where you're
                going, and never send money to someone you haven't met in
                person.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              BE UNINTERRUPTED, SECURE, OR ERROR-FREE. WE DO NOT GUARANTEE THAT
              YOU WILL FIND A ROMANTIC PARTNER OR THAT ANY MATCHES WILL BE
              COMPATIBLE.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, lovento SHALL NOT BE
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              You agree to indemnify and hold harmless lovento and its
              ...
              Terms, or violation of any rights of another person or entity.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              cease. If you wish to terminate your account, you may do so
          ...
          <div className="border-t pt-6 mt-8">
            <p className="text-sm text-gray-500 italic">
              By using lovento, you acknowledge that you have read, understood,
