        ...
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Making lovento safe and welcoming for everyone
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  lovento is built on respect, authenticity, and kindness. These
                  guidelines help create a safe, inclusive community where
          ...
          <section className="space-y-4">
            ...
            <div className="pl-13 space-y-3">
              <p className="text-gray-700 leading-relaxed">
                Authenticity is the foundation of meaningful connections. We
                encourage you to:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>
                  Represent yourself accurately - no celebrity photos, heavily
                  filtered images, or group photos as your main picture
                </li>
              </ul>
              ...
              <div className="bg-red-50 border-l-4 border-red-400 p-4 mt-4">
                ...
                <p className="text-red-800 mt-1">
                  Catfishing, impersonation, and fake profiles result in
          ...
          <section className="space-y-4">
            ...
            <div className="pl-13 space-y-3">
              <p className="text-gray-700 leading-relaxed">
                Treat every person with dignity and respect, even if you're not
                interested:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>
                  Be kind in your messages - rejection doesn't require rudeness
                </li>
                <li>Respect boundaries - "no" means no</li>
                <li>
                  Don't harass, stalk, or send unsolicited explicit content
                </li>
                <li>
                  Accept that not everyone will be interested, and that's okay
                </li>
                <li>
                  Use appropriate language - no hate speech, slurs, or
                  derogatory terms
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-gray-700 text-sm">
                    ...
                    <li>
                      Sexual content involving minors (reported to authorities)
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-gray-700 text-sm">
                    <li>
                      Hate speech based on race, ethnicity, religion, gender,
          ...
          <section className="space-y-4">
            ...
            <div className="pl-13 space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>
                  <strong>Meet in Public:</strong> First meetings should always
                  be in public places
                </li>
                <li>
                  <strong>Tell Someone:</strong> Let a friend or family member
                ...
                <li>
                  <strong>Don't Share Financial Info:</strong> Never send money
                  or share bank details
                </li>
                <li>
                  <strong>Protect Personal Info:</strong> Don't share your
                  address, workplace, or other sensitive details early on
                </li>
                <li>
                  <strong>Stay on Platform:</strong> Keep conversations on
                  lovento until you feel comfortable
                </li>
                <li>
                  <strong>Report Concerns:</strong> Use our report feature for
                  suspicious behavior
                </li>
              </ul>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mt-4">
                ...
                <p className="text-yellow-800 mt-1">
                  We do not conduct background checks. You are responsible for
                  your own safety and interactions with others.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="pl-13 space-y-3">
              <p className="text-gray-700 leading-relaxed">
                Help us keep lovento safe by reporting violations:
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mt-3">
                <strong>All reports are confidential and anonymous.</strong> The
                reported user will not know you reported them.
              </p>

              <p className="text-gray-700 leading-relaxed">
                For emergencies or illegal activity, contact local law
          ...
          <section className="space-y-4">
            ...
            <div className="pl-13 space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>
                  <strong>Warning:</strong> First-time minor violations receive
                  a warning
                </li>
                <li>
                  <strong>Content Removal:</strong> Inappropriate content is
                  deleted
                </li>
                <li>
                  <strong>Temporary Suspension:</strong> Account suspended for
                  7-30 days
                </li>
                <li>
                  <strong>Permanent Ban:</strong> Serious or repeated violations
                  result in permanent account termination
                </li>
                <li>
                  <strong>Legal Action:</strong> Illegal activity is reported to
                  law enforcement
                </li>
              </ul>
          ...
          <section className="space-y-4">
            ...
            <div className="pl-13 space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>
                  <strong>AI Detection:</strong> Automated systems scan for
                  prohibited content 24/7
                </li>
                <li>
                  <strong>Photo Verification:</strong> Optional verification to
                  prove you're real
                </li>
                <li>
                  <strong>Human Review:</strong> Trained moderators review
                  reported content
                </li>
                <li>
                  <strong>Community Reports:</strong> User reports help us
                  identify violations
                </li>
                <li>
                  <strong>Proactive Monitoring:</strong> Random checks to ensure
                  compliance
                </li>
              </ul>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="pl-13 space-y-3">
              <p className="text-gray-700 leading-relaxed">
                Beyond following rules, here's how to be a great community
                member:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              We may update these guidelines as our community grows. We'll
              notify you of significant changes. Continued use of lovento
          ...
          <div className="border-t pt-6 mt-8">
            <p className="text-sm text-gray-500 italic">
              By using lovento, you agree to follow these Community Guidelines.
              Together, we can build a safe, respectful, and welcoming community
              for everyone.
            </p>
          </div>
        </div>
